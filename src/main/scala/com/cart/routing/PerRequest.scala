...
import com.cart.routing.PerRequest._
import com.cart._
import com.cart.routing.PerRequest.WithActorRef

import java.util.UUID

/**Actor implementing a per-request pattern of request processing */
...
import context._
  ...
  def receive = {
    case res: RestCreated => complete(Created, res) 
